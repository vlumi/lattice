...
echo "Building Lattice-iOS..."
xcodebuild -project Lattice.xcodeproj -scheme Lattice-iOS \
...
app="$derived/Build/Products/Debug-iphonesimulator/Lattice Five.app"
