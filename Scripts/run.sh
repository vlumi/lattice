...
derived=".build-xcode"
echo "Building Lattice-macOS..."
xcodebuild -project Lattice.xcodeproj -scheme Lattice-macOS -destination "platform=macOS" \
...
app="$derived/Build/Products/Debug/Lattice Five.app"
